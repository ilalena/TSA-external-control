...
class FakeConfig():
    address = '192.168.1.160' #change this IP address to be the same as in external control configuration screen
    port = 20121
    debug = 1
...
class medocResponse():
    ...
    def __init__(self, response):
        ...
        self.timestamp = intFromBytes(self.timestamp1) 
	...
	self.ttl        = intFromBytes(response[22:23])
